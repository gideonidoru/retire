...
| **Household** | A spouse's pension (deferred start supported), Social Security (their own FRA and claim age), SSDI (the full PIA, unreduced, from any age — it supersedes the claim age and converts at their FRA), VA disability (tax-free, for life), balance draws with their own RMD forcing, and wages while working; joint taxes and IRMAA; the plan runs to the longer-lived of you |
...
| **Disability** | FERS disability retirement: 60% year one, 40% minus the SSDI offset to 62, the earned-annuity floor, and the age-62 recompute with disability years credited; a spouse on SSDI, taxed under the Social Security rules and flat in real terms (SSDI carries the same COLA) |
